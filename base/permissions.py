...
class AccountPermissions(BasePermissionEnum):
    MANAGE_RETAILERS = "custom_auth.manage_retailers"
    MANAGE_CUSTOMERS = "custom_auth.manage_customers"
    MANAGE_SALES = "custom_auth.manage_sales"
    MANAGE_SUPPLY= "custom_auth.manage_supply"
    MANAGE_OPERATIONS= "custom_auth.manage_operations"
    MANAGE_FARMER = "custom_auth.manage_staff"
...
class FeedProductPermissions(BasePermissionEnum):
    MANAGE_PRODUCTS = "feedproduct.manage_products"
